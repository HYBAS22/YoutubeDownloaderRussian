...
public class QueryResolver
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (isUrl && PlaylistId.TryParse(query) is { } playlistId)
        {
            ...
            return new QueryResult(QueryResultKind.Playlist, $"Плейлист: {playlist.Title}", videos);
        }
        ...
        if (isUrl && ChannelId.TryParse(query) is { } channelId)
        {
            ...
            return new QueryResult(QueryResultKind.Channel, $"Канал: {channel.Title}", videos);
        }
        ...
        // Search
        {
            ...
            return new QueryResult(QueryResultKind.Search, $"Поиск: {query}", videos);
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new QueryResult(QueryResultKind.Aggregate, $"{queries.Count} очередей", videos);
    }
}